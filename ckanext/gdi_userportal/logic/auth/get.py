...
def config_option_show(next_auth, context, data_dict=None):
    ...
    To allow the "ckanext.portal.intro_text" Config Option to be publicly accessible
    '''
    if data_dict is None:
        data_dict = {}

    if context.get('ignore_auth', False) or data_dict.get('key') == 'ckanext.portal.intro_text':
        return {'success': True}
